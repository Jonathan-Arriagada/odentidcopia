                                    ...
                                    <div className="d-flex justify-content-end">
                                        ...
                                        <div className="col d-flex justify-content-end">
                                            <button
                                                ...
                                                onClick={() => { setEditIndex(null); setModalShowGestionProveedores(true) }}>
                                                Nuevo
                                            </button>
                                        </div>
                                    </div>
                                            ...
                                            <tr key={proveedor.id}>
                                                ...
                                                <td>
                                                    <button
                                                        ...
                                                        onClick={() => { setModalShowGestionProveedores(true); handleEdit(index) }}
                                                    >
                ...
                >
                    ...
                    <Modal.Body>
                        <form onSubmit={editIndex !== null ? handleUpdate : handleCreate}>
                            ...
                            <div className="mb-3">
                                <label className="form-label">Denominacion o Nombre Proveedor*</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    value={proveedor}
