...
export default function History() {
  ...
  const handleActualizarClick = async (e) => {
    ...
    const newData = {
      ...
      tratamiento: tratamiento || clientData.tratamiento,
      fecha: fecha || clientData.fecha,
      doctor: doctor || clientData.doctor,
      detalle: detalle || clientData.detalle,
    };
              ...
              <div className="col-md-4 mb-3">
                ...
                <div className="row">
                  ...
                  <input
                    ...
                    type="text"
                    className="form-control m-1"
                    placeholder={isChecked[2] ? "¿Psiquiatra o Psicologo?" : ""}
